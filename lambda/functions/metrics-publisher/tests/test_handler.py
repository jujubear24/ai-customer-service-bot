"""Unit tests for metrics-publisher handler."""
...
def lambda_context() -> Mock:
    ...
    context = Mock()
    context.function_name = "metrics-publisher"
    context.function_version = "$LATEST"
    context.invoked_function_arn = (
        "arn:aws:lambda:us-east-1:123456789012:function:metrics-publisher"
    )
    context.memory_limit_in_mb = 128
    context.aws_request_id = "test-request-id"
    context.log_group_name = "/aws/lambda/metrics-publisher"
...
class TestProcessEvent:
    ...
    def test_process_event_success(self, sample_event: dict, lambda_context: Mock) -> None:
        ...
        assert result["function"] == "metrics-publisher"
